...
public class CanvasController : MonoBehaviour
{
    ...
    public Transform PromptAnchor; //Position of object to align PromptBox to = Camera Track object, slightly above player head
    TMP_Text PromptText;
    ...
    Animator DialogueUI, CharLeft, CharRight, Blackout;
    ...
    private void OnEnable()
    {
        if (CC == null)
        {
            ...
            Blackout = transform.Find("Blackout").GetComponent<Animator>();
    ...
    {
        Blackout.ResetTrigger("show");
        Blackout.ResetTrigger("hide");

        if (b)
        {
            Blackout.SetTrigger("show");
        } else
        {
            Blackout.SetTrigger("hide");
        }
    }
    ...
    public void SetPortrait(string Portrait)
    {
        ...
        } else
        {
            ...
            sp = Resources.Load<Sprite>("Sprites/Dialogue Ani/Hide");
        }
